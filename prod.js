...
const filePath = path.join(__dirname, 'xlsx_files', 'DadosProdutividade_2024.xlsx');
const outputFolderPath = path.join(__dirname, 'dados_SSP');
const outputFileName = 'dados_SSP_produtividade.txt';
...
const MONTH = 2;
const COLUMN_INDEX = 35; 

function countOccurrences(workbook, cityName, month, columnIndex) {
    const occurrences = {};
    ...
    workbook.SheetNames.forEach(sheetName => {
        ...
        for (let rowNum = range.s.r + 1; rowNum <= range.e.r; rowNum++) {
            const cityCellAddress = { c: 7, r: rowNum }; 
            ...
            const monthCellAddress = { c: 36, r: rowNum }; 
